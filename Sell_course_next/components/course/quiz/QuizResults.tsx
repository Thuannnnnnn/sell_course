    ...
    <div className="w-full max-w-4xl mx-auto px-4 space-y-6 overflow-hidden">
      <Card className={`border shadow-sm overflow-hidden ${
        ...
        <div className={`p-6 text-center ${
          ...
          <div className="text-5xl font-bold mb-3">{result.score}%</div>
          ...
          <div className="bg-muted/50 p-4 rounded-lg border">
            ...
            <div className="space-y-3">
              {(['easy', 'medium', 'hard'] as const).map((difficulty) => {
                ...
                return (
                  <div key={difficulty} className={`p-4 rounded-lg border-2 ${colors.bg} ${colors.border}`}>
            ...
            <div className="text-center">
              {isPassed ? (
                <div>
                  ...
                  <h4 className="text-lg font-bold text-green-700 mb-1">Excellent Work!</h4>
                  <p className="text-sm text-green-600">You&apos;ve demonstrated a strong understanding of the material. Keep up the great work!</p>
                </div>
              ) : (
                <div>
                  <Target className="h-8 w-8 text-blue-600 mx-auto mb-2" />
                  <h4 className="text-lg font-bold text-blue-700 mb-1">Keep Learning!</h4>
                  <p className="text-sm text-blue-600">Review the material and try again. Every attempt helps you learn and improve!</p>
                </div>
              )}
            </div>
          </div>
        ...
        <CardFooter className="flex flex-col sm:flex-row justify-center gap-4 p-6 bg-muted/30">
          <Button 
            onClick={onReview}
            size="lg"
            variant="outline"
