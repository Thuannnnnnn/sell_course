  ...
  return (
    <div className="sidebar">
      <ul>
        ...
        <Link
          className="link-text"
          href={`/${localActive}/profile/enrolledCourse/enrolledPage`}
        >
          <li
            className={isActive(
              `/${localActive}/profile/enrolledCourse/enrolledPage`
            )}
          >
            <div className="icon-sidebar">
              <BsMortarboardFill />
        ...
        <Link
          className="link-text"
          href={`/${localActive}/profile/orderHistory`}
        >
        ...
        >
          <li
            className={
              isActive(`/${localActive}/profile/setting/updateMyProfile`) ||
              isActive(`/${localActive}/profile/setting/changePassword`)
            }
          >
            <div className="icon-sidebar">
              <IoSettingsSharp />
        ...
        <Link
          className="link-text"
          href={`/${localActive}/profile/certificate`}
        >
          <li
            className={
              isActive(`/${localActive}/profile/certificate`) ||
              isActive(`/${localActive}/profile/certificate`)
            }
          >
            <div className="icon-sidebar">
