...
//               <span className="question-number">Question {index + 1}/{questions.length}</span>
//             </div>
//             <p className="question-text">{question.question}</p>
//             <div className="answers-list">
//               {question.answers.map((answer) => (
//                 <label key={answer.answerId} className={`answer-item ${submitted && answer.isCorrect ? "correct-answer" : ""}`}>
//                   <input
//                     type="radio"
