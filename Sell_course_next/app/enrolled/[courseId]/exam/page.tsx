  ...
  const renderActionButton = () => {
    if (status === "loading" || isCheckingEnrollment) {
      return (
        <Button
          disabled
          className="w-full bg-gray-400 text-white py-3 rounded-xl font-semibold transition mb-2"
        >
          Loading...
        </Button>
      );
    ...
    if (isEnrolled) {
      return (
        <Button
          disabled
          className="w-full bg-green-600 text-white py-3 rounded-xl font-semibold transition mb-2"
        >
          ✓ Enrolled
        </Button>
      );
